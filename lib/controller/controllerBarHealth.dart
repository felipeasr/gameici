...
import 'package:gameici/view/education/CardsEducaUser.dart';
...
class ControllerBarHealth extends StatefulWidget {
  ...
  ControllerBarHealth(this._paginaAtual, this._selectedIndex, {super.key});

  @override
  _ControllerBarHealth createState() => _ControllerBarHealth();
}

class _ControllerBarHealth extends State<ControllerBarHealth> {
  String _user = '';
  @override
  void initState() {
    super.initState();

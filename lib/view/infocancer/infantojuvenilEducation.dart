...
import 'package:gameici/view/infocancer/cancerinfantojuvenilEducation.dart';
...
class InfoCancerEducation extends StatefulWidget {
  const InfoCancerEducation({super.key});

  @override
  _InfoCancerEducation createState() => _InfoCancerEducation();
}

class _InfoCancerEducation extends State<InfoCancerEducation> {
  String _user = '';
  @override
  void initState() {
    super.initState();
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          CancerInfatojuvenilEducation(controller)));
                            },
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              mainAxisAlignment: MainAxisAlignment.center,
